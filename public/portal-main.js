  ...
  try {
    ...
    profileContent.innerHTML = `
      <div class="d-flex flex-column align-items-center justify-content-center">
        ...
        <div class="mb-2"><b>Matric No:</b> ${student.matricNumber || '-'}</div>
...
async function loadAdminDashboard() {
            ...
            <div class="card glassmorphism p-2">
              <div class="d-flex align-items-center">
                ...
                <div>
                  ...
                  <button class="btn btn-sm btn-link view-student-btn mt-2 p-0" data-reg="${s.matricNumber}"><i class="bi bi-eye"></i> View Details</button>
                </div>
              </div>
            </div>
          </div>
  ...
  groupsDiv.querySelectorAll('.view-student-btn').forEach(btn => {
    btn.onclick = function () {
      ...
      const student = students.find(s => s.matricNumber === reg);
      if (!student) return;
...
// --- Assignments Section ---
/* ...from here down, your original logic is preserved, no field changes required... */
